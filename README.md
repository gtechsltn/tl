...
Tôi hy vọng là với bài viết dài này đã cung cấp cho các bạn rõ hơn về vai trò và trách nhiệm của một TL trong dự án. Các công việc nêu trên là các công việc cơ bản chứ không phải toàn bộ các công việc mà một TL có thể làm. Để trở thành TL sẽ cần rất nhiều tố chất và có nhiều tố chất sẽ cần được mài dũa trong chính quá trình làm việc.
